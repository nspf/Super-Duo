        ...
        try {
            ...
            for(int i = 0;i < matches.length();i++) {
                        ...
                        League.equals(PRIMERA_LIGA)         )
                {
                    ...
                    SimpleDateFormat match_date = new SimpleDateFormat(
                            getResources().getString(R.string.match_date_format), Locale.getDefault());
                    match_date.setTimeZone(TimeZone.getTimeZone("UTC"));
                    try {
                        Date parseddate = match_date.parse(mDate+mTime);
                        SimpleDateFormat new_date = new SimpleDateFormat(
                                getResources().getString(R.string.new_date_format), Locale.getDefault());
